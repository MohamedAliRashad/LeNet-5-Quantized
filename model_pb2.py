...
_WEIGHTS = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="quantize_min",
            full_name="Weights.quantize_min",
            index=5,
            number=6,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="quantize_max",
            full_name="Weights.quantize_max",
            index=6,
            number=7,
            type=2,
            cpp_type=6,
